...
config :chatter, Chatter.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "UId5g5wIcQLINAYb/BG4OWxprqGBiMl4sp5cdEXA288h2CTJL1qnbMHcWbLUTvK3",
...
config :guardian, Guardian,
  ...
  allowed_drift: 2000,
  verify_issuer: true,
  secret_key: "N41GIKZtm2XsRQWUndO/M9FPL+WmeQ4S/49ER47Dv7CkupqY8BE9LjITz1bmhMxS",
